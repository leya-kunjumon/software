...
#***********************developer***********************************************
    ...
    path('admin_emp_dept',views.admin_emp_dept),  
    path('admin_projects',views.admin_projects), 
    path('admin_proj_list', views.admin_proj_list),
    ...
    path('admin_emp_profile', views.admin_emp_profile),
    ...
    path('admin_upcoming',views.admin_upcoming),
    ...
    path('admin_givetask',views.admin_givetask),
