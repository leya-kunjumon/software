...
urlpatterns = [
 ...
 #***********************course***********************************************
    ...
    path('manager_course/', training_views.manager_course, name='manager_course'),
    path('manager_emp_course_list/', training_views.manager_emp_course_list,name='manager_emp_course_list'),
    path('manager_emp_course_details/', training_views.manager_emp_course_details,name='manager_emp_course_details'),
    path('manager_emp_profile/', training_views.manager_emp_profile,name='manager_emp_profile'),
    path('manager_emp_attendance/', training_views.manager_emp_attendance,name='manager_emp_attendance'),
    path('manager_emp_attendance_show/', training_views.manager_emp_attendance_show,name='manager_emp_attendance_show'),
    path('manager_task/', training_views.manager_task, name='manager_task'),
    path('manager_givetask/', training_views.manager_givetask, name='manager_givetask'),
    ...
    path('manager_registration_details/', training_views.manager_registration_details,name='manager_registration_details'),
    path('manager_attendance/', training_views.manager_attendance,name='manager_attendance'),
    path('manager_attendance_show/', training_views.manager_attendance_show,name='manager_attendance_show'),
    path('manager_reported_issues/', training_views.manager_reported_issues,name='manager_reported_issues'),
    path('manager_issues/', training_views.manager_issues, name='manager_issues'),
    path('manager_issues_form/', training_views.manager_issues_form,name='manager_issues_form'),
    path('manager_myissues/', training_views.manager_myissues, name='manager_myissues'),
    path('manager_reported_detail/', training_views.manager_reported_detail,name='manager_reported_detail'),
    path('manager_reported_issue_show/', training_views.manager_reported_issue_show,name='manager_reported_issue_show'),
